...
export default function App() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SplashScreen, {}), isFirstRun && (_jsxs("div", { style: {
                    ...
                    padding: '24px',
                    gap: '24px',
                }, children: [_jsx("h1", { style: { margin: 0, fontSize: '2rem', color: 'var(--text)' }, children: "Time Compass" }), _jsx("p", { style: { margin: 0, color: 'var(--text-secondary)', textAlign: 'center', maxWidth: 300 }, children: "Welcome! Restore your data to get started." }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 12, width: '100%', maxWidth: 320 }, children: [_jsx("button", { className: "btn btn-primary btn-block", onClick: () => setShowData(true), children: "Import backup file" }), !showFirstRunClientIdForm ? (_jsx("button", { className: "btn btn-secondary btn-block", onClick: () => setShowFirstRunClientIdForm(true), children: "Connect Google Drive" })) : (_jsxs("div", { style: {
                                    ...
                                    flexDirection: 'column',
                                    gap: 8,
                                }, children: [_jsx("label", { className: "form-label", children: "Google Client ID" }), _jsx("input", { className: "form-input", type: "text", placeholder: "your-id.apps.googleusercontent.com", value: firstRunClientId, onChange: e => setFirstRunClientId(e.target.value), autoFocus: true }), _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [_jsx("button", { className: "btn btn-secondary btn-sm", onClick: () => { setShowFirstRunClientIdForm(false); setFirstRunClientId(''); }, type: "button", children: "Cancel" }), _jsx("button", { className: "btn btn-primary btn-sm", disabled: !firstRunClientId.trim(), onClick: () => {
                                                    ...
                                                    setFirstRunClientId('');
                                                }, type: "button", children: "Save & connect" })] })] }))] })] })), _jsxs("div", { className: "app-layout", children: [_jsxs("header", { className: "app-header", children: [_jsx("h1", { children: "Time Compass" }), _jsxs("div", { className: "header-actions", children: [_jsx("button", { className: "btn btn-ghost btn-sm", onClick: () => {
                                            setEditSettings({
                                                enabled: state.settings.gamification.enabled,
                                                monthlyRewardBudget: String(state.settings.gamification.monthlyRewardBudget),
                                                pointsPerTargetHour: String(state.settings.gamification.pointsPerTargetHour),
