...
export function getPeriodIndex(weekStart) {
...
export function getPeriodDateRange(periodIndex) {
...
export function getWeekWithinPeriod(weekStart, periodIndex) {
...
export function pointsToEuros(actualPoints, maxWeekPoints, budget) {
    if (maxWeekPoints === 0 || budget === 0)
        return 0;
